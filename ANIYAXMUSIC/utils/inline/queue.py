...
def aq_markup(_, chat_id):
    buttons = [
        [
            api_btn(text=" ", callback_data=f"ADMIN Resume|{chat_id}", style="success", custom_emoji_id="5219899949281453881"),
            api_btn(text=" ", callback_data=f"ADMIN Pause|{chat_id}", style="primary", custom_emoji_id="5334811859415477124"),
            api_btn(text=" ", callback_data=f"ADMIN Skip|{chat_id}", style="primary", custom_emoji_id="5222148368955877900"),
            api_btn(text=" ", callback_data=f"ADMIN Stop|{chat_id}", style="danger", custom_emoji_id="5219805369806629055"),
        ],
        [
            api_btn(text=_["CLOSE_BUTTON"], callback_data="close", style="danger", custom_emoji_id="5999100917645841519")
        ],
    ]
    return buttons
