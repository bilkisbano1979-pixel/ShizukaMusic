...
from ANIYAXMUSIC.utils.database import get_assistant
from ANIYAXMUSIC.utils.decorators.language import languageCB
from ANIYAXMUSIC.utils.formatters import seconds_to_min
from ANIYAXMUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await ANIYA.pause_stream(chat_id)
        ...
        await ANIYA.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
