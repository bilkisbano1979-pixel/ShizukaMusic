...
@app.on_callback_query(filters.regex("ANIYAmousAdmin") & ~BANNED_USERS)
async def ANIYAmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("ANIYAPlaylists") & ~BANNED_USERS)
@languageCB
